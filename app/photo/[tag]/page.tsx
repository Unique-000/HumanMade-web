...
export default function Page(){
    ...
    return(
        <div className=''>
            <Image src={photoData.url} alt='Verified image' width={bigger ? 1200 : 700} height={bigger ? 1200 : 700}
            className={`rounded-[30] cursor-pointer ${bigger ? "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" : ""}`}
            onClick={makeBigger}/>
            <div className='bg-neutral-300/30 w-100 h-70 rounded-[30] p-8 m-auto mt-10'>
                ...
                <p className='text-white text-lg bg-neutral-200/30 rounded-[5] flex items-stretch mb-3'>
                    ...
                    <span className='ml-1 flex items-center'>{photoData.sha256.slice(2,21)}...</span>
                    <svg onClick={() => navigator.clipboard.writeText(photoData.sha256)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='ml-auto mr-1 mt-[2] flex items-center'>
                ...
                <p className='text-white text-lg bg-neutral-200/30 rounded-[5] flex items-stretch mb-3'>
                    ...
                    <span className='ml-1 flex items-center'>{photoData.phash.slice(2,21)}...</span>
                    <svg onClick={() => navigator.clipboard.writeText(photoData.phash)} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className='ml-auto mr-1 mt-[2] flex items-center'>
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M7 9.667a2.667 2.667 0 0 1 2.667 -2.667h8.666a2.667 2.667 0 0 1 2.667 2.667v8.666a2.667 2.667 0 0 1 -2.667 2.667h-8.666a2.667 2.667 0 0 1 -2.667 -2.667l0 -8.666" />
                        <path d="M4.012 16.737a2.005 2.005 0 0 1 -1.012 -1.737v-10c0 -1.1 .9 -2 2 -2h10c.75 0 1.158 .385 1.5 1" />
                    </svg>
