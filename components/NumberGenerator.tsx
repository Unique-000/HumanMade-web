...
export default function NumberGenerator(){
    ...
    return (
        <div className="flex flex-col justify-around bg-[#AFFF5D] w-full sm:w-140 h-fit space-y-10 rounded-[30] p-10">
            ...
            <div onClick={() => navigator.clipboard.writeText(number.toString())} className="flex justify-center bg-[#C6FF0E] h-10 w-full rounded-[10] cursor-pointer">
