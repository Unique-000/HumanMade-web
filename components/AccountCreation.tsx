    ...
    return (
        <div className="flex flex-col justify-around bg-[#AFFF5D] w-140 h-120 rounded-[30] ">
            <div className="mr-auto ml-auto pl-10 pr-10">
                ...
                <p className="text-[#4C5C18] text-lg">Your account number is the only identifier you need to use our service. For security and privacy reasons we cannot show it again after login.</p>
            </div>
            <div className="flex justify-center -m-10">
                <input type="checkbox" className="" id="check"/>
                <p className="text-[#4C5C18] text-xl ml-5 font-semibold">I confirm that I’ve saved my account number.</p>
            </div>
